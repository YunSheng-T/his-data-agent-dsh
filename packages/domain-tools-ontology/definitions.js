...
export function buildDefinitions(p, { repo, modeling, anchor } = {}) {
  ...
  return [
    ...
    { name: 'ontology_policy_get_policies', risk: 'read', category: FUNC,
    ...
    { name: 'ontology_policy_get_rules', risk: 'read', category: FUNC,
    ...
    { name: 'ontology_rule_get_implementations', risk: 'read', category: FUNC,
    ...
    { name: 'ontology_platform_get_policies', risk: 'read', category: FUNC,
    ...
    { name: 'ontology_platform_get_rules', risk: 'read', category: FUNC,
    ...
    { name: 'ontology_platform_get_job_types', risk: 'read', category: FUNC,
    ...
    { name: 'ontology_job_type_get_platform', risk: 'read', category: FUNC,
    ...
    { name: 'ontology_rule_impl_get_job_type', risk: 'read', category: FUNC,
    ...
    { name: 'ontology_model_get_fields', risk: 'read', category: FUNC,
    ...
    { name: 'ontology_model_get_implementing_jobs', risk: 'read', category: FUNC,

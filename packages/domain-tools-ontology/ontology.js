...
export const FUNCTIONS = [
  ...
  { name: 'Policy.getPolicies', risk: 'read', returns: '平台策略', purpose: 'covers(逆向) 取覆盖某平台的策略' },
  { name: 'Policy.getRules', risk: 'read', returns: '策略下规则', purpose: 'containsRule 取策略下的规则' },
  { name: 'Rule.getImplementations', risk: 'read', returns: '规则实现', purpose: 'implementedBy 取规则实现（engine 指向执行器）' },
  { name: 'PlatformInstance.getPolicies', risk: 'read', returns: '平台策略', purpose: 'covers(逆向) 从平台侧取策略' },
  { name: 'PlatformInstance.getRules', risk: 'read', returns: '平台规则', purpose: 'appliesTo(逆向) 取平台规则' },
  { name: 'PlatformInstance.getJobTypes', risk: 'read', returns: '平台作业类型', purpose: 'hasJobType 取平台作业类型' },
  { name: 'JobType.getPlatform', risk: 'read', returns: '归属平台', purpose: 'hasJobType(逆向) 取作业类型归属平台' },
  { name: 'RuleImpl.getJobType', risk: 'read', returns: '绑定作业类型', purpose: 'bindsJobType 取实现绑定的作业类型' },
  { name: 'Model.getFields', risk: 'read', returns: '模型字段', purpose: 'hasField 取模型字段' },
  { name: 'Model.getImplementingJobs', risk: 'read', returns: '实现作业', purpose: 'implements(逆向) 取实现模型的作业' },
